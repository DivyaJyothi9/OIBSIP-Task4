...
public class Task5_DigitalLibraryManagement extends JFrame implements ActionListener {
    ...
    public Task5_DigitalLibraryManagement() {
    ...
    public static void main(String[] args) {
        new Task5_DigitalLibraryManagement();
    }
}