...
class OnlineTestBegin extends JFrame implements ActionListener
{
    ...
    void set()
    {
        ...
        if(current==0)
        {
            l.setText("Que1: Which keyword is used for inheritance in Java?");
            jb[0].setText("extend");jb[1].setText("inherits");jb[2].setText("implements");jb[3].setText("inheritsfrom");
        }
        if(current==1)
        {
            l.setText("Que2:What is the default value of the data type 'float' in Java?");
            jb[0].setText("0.0");jb[1].setText("0");jb[2].setText("0.0f");jb[3].setText("null");
        }
        if(current==2)
        {
